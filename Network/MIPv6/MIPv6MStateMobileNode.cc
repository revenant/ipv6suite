...
//#include "IPv6Encapsulation.h" // tunnel for home test init
...
//  bule->setToken(MIPv6MHT_HoT, UNSPECIFIED_BIT_64);
  ...
  if (coa != mipv6cdsMN->homeAddr())
  {
    ...
    dgram_hoti->setHopLimit(mob->ift->interfaceByPortNo(0)->curHopLimit);
...
//  bule->setToken(MIPv6MHT_CoT, UNSPECIFIED_BIT_64);
  ...
  dgram_coti->setHopLimit(mob->ift->interfaceByPortNo(0)->curHopLimit);
...
)
{
  ...
  dgram->setHopLimit(mob->ift->interfaceByPortNo(0)->curHopLimit);
