...
#if !defined INTERFACE6ENTRY_H
#define INTERFACE6ENTRY_H
 ...
 *  @brief An Interface entry for the Interface table
 */
class Interface6Entry
{
public:

  Interface6Entry(const char* int_name = NULL);

  virtual ~Interface6Entry() {}
  //virtual const char *className() const { return "Interface6Entry"; }
  ////Let the compiler generate these we want memberwise copy of members.
  ///There are no pointers so this is safe.
  //Interface6Entry(const Interface6Entry& obj);
  //Interface6Entry& operator=(const Interface6Entry& obj);
