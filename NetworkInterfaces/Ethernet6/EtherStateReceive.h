// -*- C++ -*-
// $Header: /home/cvs/IPv6Suite/IPv6SuiteWithINET/NetworkInterfaces/Ethernet6/EtherStateReceive.h,v 1.1 2005/02/09 06:15:58 andras Exp $
//
//
// Eric Wu
...
/*
	@file EtherStateReceive.h
	@brief Header file for EtherStateReceive
...
#ifndef __ETHER_STATE_RECEIVE_H__
#define __ETHER_STATE_RECEIVE_H__
...
class EtherStateReceive : public EtherState
{
public:
  static EtherStateReceive* instance(void);

  virtual std::auto_ptr<cMessage> processSignal(EtherModule* mod, std::auto_ptr<cMessage> msg);

protected:
  EtherStateReceive(void);
...
protected:
  static EtherStateReceive* _instance;
};
