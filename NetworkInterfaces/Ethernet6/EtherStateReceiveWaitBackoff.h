// -*- C++ -*-
// $Header: /home/cvs/IPv6Suite/IPv6SuiteWithINET/NetworkInterfaces/Ethernet6/EtherStateReceiveWaitBackoff.h,v 1.2 2005/02/10 05:59:32 andras Exp $
//
//
// Eric Wu
...
/*
    @file EtherStateReceiveWaitBackoff.h
    @brief Header file for EtherStateReceiveWaitBackoff
...
#ifndef __ETHER_STATE_RECEIVE_WAIT_BACKOFF_H__
#define __ETHER_STATE_RECEIVE_WAIT_BACKOFF_H__
...
class EtherStateReceiveWaitBackoff : public EtherStateWait
{
public:
  static EtherStateReceiveWaitBackoff* instance(void);
...
protected:
  EtherStateReceiveWaitBackoff(void);
...
protected:
  static EtherStateReceiveWaitBackoff* _instance;
};
